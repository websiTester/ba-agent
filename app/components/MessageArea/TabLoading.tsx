// TabLoading.tsx - Overlay loading component with subtle backdrop
...
export default function TabLoading({ 
  ...
  return (
    <div 
      className="absolute inset-0 z-10 flex items-center justify-center bg-white/40 backdrop-blur-sm animate-fadeIn"
      role="status"
      aria-live="polite"
