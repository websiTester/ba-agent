...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem('user', JSON.stringify({ email: account.email }));
      ...
      <div className="relative z-10 min-h-screen flex">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
          ...
          >
            ...
            >
              Sign in to continue to BA Agent
            </p>
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center cursor-pointer">
                  ...
                  <div 
                    ...
                    style={{
                      background: rememberMe ? 'linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%)' : 'rgba(30, 20, 50, 0.6)',
                      borderColor: rememberMe ? 'transparent' : 'rgba(100, 130, 255, 0.3)',
                    }}
                  >
                    {rememberMe && (
                  ...
                  <span 
                    ...
                    style={{ color: 'rgba(180, 190, 220, 0.8)' }}
                  >
                    Remember me
                  </span>
                </label>
                <a 
                  ...
                  style={{ color: 'rgba(150, 170, 255, 0.9)' }}
                  onMouseEnter={(e) => e.currentTarget.style.color = 'rgba(180, 200, 255, 1)'}
                  onMouseLeave={(e) => e.currentTarget.style.color = 'rgba(150, 170, 255, 0.9)'}
                >
                  Forgot password?
                </a>
              </div>
